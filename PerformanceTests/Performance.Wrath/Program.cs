...
namespace Performance.Wrath
{
    internal class Program
    {
        private static Output _output = new Output("Error codes", "TryCatch");
        private const int TestNo = 20;
        private const int IterationNo = 10000000;

        private static void ReturnCodes()
        {
        ...
        public static string Join(string separator, IReadOnlyList<string> strings)
        {
